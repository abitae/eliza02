<x-app-layout>
    <div class="row">
        ...
        <x-adminlte-card title="Form Card" theme="maroon" theme-mode="outline" class="elevation-3"
            body-class="bg-maroon" header-class="bg-light" footer-class="rounded bg-maroon border-top border-light"
            icon="fas fa-lg fa-bell" collapsible removable maximizable>
            <x-slot name="toolsSlot">
                <select class="w-auto custom-select form-control-border bg-light">
            ...
            <x-slot name="footerSlot">
                <x-adminlte-button class="ml-auto d-flex" theme="light" label="submit" icon="fas fa-sign-in" />
            </x-slot>
        </x-adminlte-card>
        ...
        <x-adminlte-profile-widget class="elevation-4" name="Willian Dubling" desc="Web Developer"
            ...
            header-class="text-right text-white" footer-class='bg-gradient-dark'>
